# 📘 Manual de Usuario — Yogurt Maker API

**Versión:** 0.0.1-SNAPSHOT  
**Última actualización:** Mayo 2026  
**Autora:** Alisson Arango Moncada  
...
**Yogurt Maker** es una API REST diseñada como proyecto de aula para gestionar el proceso completo de producción de yogurt artesanal. A través de sus endpoints es posible:
...
*Proyecto de aula — Lógica para Solución de Problemas — Alisson Arango Moncada*
