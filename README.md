# 🥛 Yogurt Maker — API de Gestión de Producción de Yogurt
...
**Yogurt Maker** es una API REST desarrollada con **Spring Boot** como proyecto de aula de la materia **Lógica para Solución de Problemas**. Gestiona el ciclo de vida completo de la producción de yogurt artesanal. Permite:
...
git clone https://github.com/alisson-1513/Logica-para-soluci-n-de-problemas.git
cd Logica-para-soluci-n-de-problemas
...
- GitHub: [@alisson-1513](https://github.com/alisson-1513)
- Materia: Lógica para Solución de Problemas
